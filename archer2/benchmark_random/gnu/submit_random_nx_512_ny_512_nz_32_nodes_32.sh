...
for i in $(seq 1 10); do
    srun --nodes=32 \
        ...
        --shuffle \
        --csvfname "archer2-gnu-shmem-random-nx-512-ny-512-nz-32-nodes-32" \
        --comm-type "shmem"
    for g in "p2p" "rma"; do
        srun --nodes=32 \
            --ntasks=4096 \
            ...
            --small-parcel-fraction 0.5 \
            --shuffle \
            --csvfname "archer2-gnu-$g-random-nx-512-ny-512-nz-32-nodes-32" \
            --comm-type "$g"
        ...
        if test "false" = "true"; then
            srun --nodes=32 \
                ...
                --small-parcel-fraction 0.5 \
                --shuffle \
                --csvfname "archer2-gnu-$g-random-nx-512-ny-512-nz-32-nodes-32-subcomm" \
                --comm-type "$g" \
                --subcomm
        fi
    done
