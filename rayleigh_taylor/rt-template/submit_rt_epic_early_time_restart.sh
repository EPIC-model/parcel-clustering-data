...
srun --unbuffered --distribution=block:block --hint=nomultithread ${EPIC_DIR}/bin/epic3d --config rt_epic_early_restart.config --restart epic_rt_NXxNYxNZ_prepare_0000000002_parcels.nc --verbose
