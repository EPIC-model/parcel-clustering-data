...
for i in $(seq 1 10); do
	...
	--hint=nomultithread \
        ...
        --shuffle \
        --csvfname "hotlum-cray-shmem-random-nx-1024-ny-1024-nz-32-nodes-64" \
        --comm-type "shmem"
    for g in "p2p" "rma"; do
        srun --nodes=64 \
            --ntasks=4096 \
            ...
            --small-parcel-fraction 0.5 \
            --shuffle \
            --csvfname "hotlum-cray-$g-random-nx-1024-ny-1024-nz-32-nodes-64" \
            --comm-type "$g"
        ...
        if test "false" = "true"; then
            srun --nodes=64 \
                ...
                --small-parcel-fraction 0.5 \
                --shuffle \
                --csvfname "hotlum-cray-$g-random-nx-1024-ny-1024-nz-32-nodes-64-subcomm" \
                --comm-type "$g" \
                --subcomm
        fi
    done
