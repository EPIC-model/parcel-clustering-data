...
for i in $(seq 1 10); do
    srun --nodes=64 \
        ...
        --shuffle \
        --csvfname "archer2-cray-shmem-random-nx-1024-ny-1024-nz-32-nodes-64" \
        --comm-type "shmem"
    for g in "p2p" "rma"; do
        srun --nodes=64 \
            --ntasks=8192 \
            ...
            --small-parcel-fraction 0.5 \
            --shuffle \
            --csvfname "archer2-cray-$g-random-nx-1024-ny-1024-nz-32-nodes-64" \
            --comm-type "$g"
        ...
        if test "false" = "true"; then
            srun --nodes=64 \
                ...
                --small-parcel-fraction 0.5 \
                --shuffle \
                --csvfname "archer2-cray-$g-random-nx-1024-ny-1024-nz-32-nodes-64-subcomm" \
                --comm-type "$g" \
                --subcomm
        fi
    done
