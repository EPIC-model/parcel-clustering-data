...
for i in $(seq 1 5); do
    for g in "p2p" "rma"; do
        srun --nodes=32 \
            ...
            --hint=nomultithread \
            /tmp/benchmark_read \
            --dirname /work/e710/e710/mf248/parcel-clustering/scripts/rayleigh_taylor/rt-64x64x64/early-time \
            --ncbasename epic_rt_64x64x64_early \
            --niter 100 \
            --offset 1 \
            --nfiles 10 \
            --size-factor 1.5 \
            --csvfname "archer2-cray-$g-read-early-nx-64-ny-64-nz-64-nodes-32" \
            --comm-type "$g"
        ...
        if test "true" = "true"; then
            srun --nodes=32 \
                ...
                --nfiles 10 \
                --size-factor 1.5 \
                --csvfname "archer2-cray-$g-read-early-nx-64-ny-64-nz-64-nodes-32-subcomm" \
                --comm-type "$g" \
                --subcomm
        fi
    done
