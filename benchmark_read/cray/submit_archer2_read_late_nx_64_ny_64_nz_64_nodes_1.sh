...
for i in $(seq 1 10); do
    srun --nodes=1 \
        ...
        --nfiles 10 \
        --size-factor 1.5 \
        --csvfname "archer2-cray-shmem-read-late-nx-64-ny-64-nz-64-nodes-1" \
        --comm-type "shmem"
    for g in "p2p" "rma"; do
        srun --nodes=1 \
            --ntasks=128 \
            ...
            --nfiles 10 \
            --size-factor 1.5 \
            --csvfname "archer2-cray-$g-read-late-nx-64-ny-64-nz-64-nodes-1" \
            --comm-type "$g"
        ...
        if test "true" = "true"; then
            srun --nodes=1 \
                ...
                --nfiles 10 \
                --size-factor 1.5 \
                --csvfname "archer2-cray-$g-read-late-nx-64-ny-64-nz-64-nodes-1-subcomm" \
                --comm-type "$g" \
                --subcomm
        fi
    done
