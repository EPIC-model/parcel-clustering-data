...
for i in $(seq 1 10); do
    srun --nodes=16 \
        ...
        --shuffle \
        --csvfname "archer2-gnu-shmem-random-nx-1024-ny-1024-nz-32-nodes-16" \
        --comm-type "shmem"
    for g in "p2p" "rma"; do
        srun --nodes=16 \
            --ntasks=2048 \
            ...
            --small-parcel-fraction 0.5 \
            --shuffle \
            --csvfname "archer2-gnu-$g-random-nx-1024-ny-1024-nz-32-nodes-16" \
            --comm-type "$g"
        ...
        if test "false" = "true"; then
            srun --nodes=16 \
                ...
                --small-parcel-fraction 0.5 \
                --shuffle \
                --csvfname "archer2-gnu-$g-random-nx-1024-ny-1024-nz-32-nodes-16-subcomm" \
                --comm-type "$g" \
                --subcomm
        fi
    done
